...
object FileOperation {
  def main(args: Array[String]): Unit = {
    ...
    val source = Source.fromFile("C://Users//Administrator//Desktop//HelloWorld.java", "UTF-8")
    ...
    val source2 = Source.fromFile("C://Users//Administrator//Desktop//HelloWorld.java", "UTF-8")
    val lines = source2.getLines.toArray
    for (line <- lines) println(line)

    //方法三: 调用Source.mkString，返回文本中所有的内容
    val source3 = Source.fromFile("C://Users//Administrator//Desktop//HelloWorld.java", "UTF-8")
    ...
    val source4 = Source.fromFile("C://Users//Administrator//Desktop//HelloWorld.java", "UTF-8")
